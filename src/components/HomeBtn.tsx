...
const HomeBtn: React.FC<HomeBtnProps> = ({ newTab = false, size = 24 }) => {
  ...
  return (
    <Link
      ...
      className="fixed top-4 left-4 z-50 flex items-center gap-2 text-white hover:text-accent"
    >
